...
var ReactNative = {findNodeHandle:_findNodeHandle};
var RCTScrollViewManager = Platform.OS === 'ios'?NativeModules.MJScrollViewManager:NativeModules.ScrollViewManager;
